...
public class VendorController implements Serializable {
    ...
    private String currentPage = "/sc/supplier/Grid.xhtml";
    private Part image;
    ...
    public void prepareCreateSupplier() {
        ...
        currentPage = "/sc/supplier/Create.xhtml";
    ...
    public void prepareEditSupplier(Integer id) {
        if (vendorExist(id)) {
            imageModified = false;
            currentPage = "/sc/supplier/Edit.xhtml";
        }
    }

    public void cancelSupplierEdit(Integer id) {
        if (vendorExist(id)) {
            partner.setCountry(countries.get(partner.getCountry()));
            currentPage = "/sc/supplier/View.xhtml";
        }
    }

    public void editSupplier(Integer id) {
        if (!vendorExistTwo(id)) {
...
//    }
    ...
    public void prepareViewSupplier() {
    ...
    public void prepareViewSupplier(int index, int id) {
    ...
    public void viewSupplier() {
        ...
        partners = null;
        currentPage = "/sc/supplier/Grid.xhtml";
    }
    ...
    public void showVendors() {
        ...
        if (isGridView) {
            ...
            currentPage = "/sc/supplier/List.xhtml";
        }
    }
    ...
    public void updatePartnerType() {
        ...
        if (searchKey != null && !searchKey.isEmpty() && currentPage.equals("/sc/supplier/Grid.xhtml")) {
            searchByName();
        }
    }
    ...
    public List<Partner> getVendorList() {
