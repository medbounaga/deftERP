...
public class SaleOrderLineQueryBuilder {
    ...
    private static final String TOTAL_PRODUCT_QUANTITY = "SELECT SUM(s.quantity) FROM SaleOrderLine s WHERE s.product.id = :productId ";
    ...
    public static QueryWrapper getTotalProductQuantityQuery(Integer productId) {
